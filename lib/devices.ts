...
let devices: Device[] = [
  {
    ...
    aiDescription: "High-performance server handling critical database operations with redundant storage and backup systems",
  ...
  },
  {
    ...
    aiDescription: "Desktop computer used by HR staff for employee management, payroll processing, and administrative tasks",
  ...
  },
  {
    ...
    aiDescription: "Multi-function network printer supporting color printing, scanning, and copying for general office use",
